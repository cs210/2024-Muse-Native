...
with_node \
  ...
  --target "/Users/pedrocivita/Documents/GitHub/2024-Muse-Native/ios/Pods/Target Support Files/Pods-supaapp/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-apple-authentication" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-router" "expo-system-ui" "expo-web-browser"
